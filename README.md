...
→ [redreamai.com](https://redreamai.com/index.html?theme=dark&lang=en)

**🧭 feelSpace** — Investigated how vibrotactile sensory augmentation affects 
...
- 🥽 Designed and conducted EEG experiments with VR
- 🏗️ Built 3D environments in Unity
- 📊 Preprocessing and statistical analysis of EEG & fMRI data
- 🌐 Full-stack development (frontend, backend, Git workflow)

**Computational toolkit**

| Languages | Web & DevOps | Neuro Toolboxes | ML / DL |
|-----------|-------------|-----------------|---------|
